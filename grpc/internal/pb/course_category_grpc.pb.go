...
type CategoryServiceClient interface {
	...
	GetCategoryById(ctx context.Context, in *CategoryRequestById, opts ...grpc.CallOption) (*CategoryResponseById, error)
}
...
func (c *categoryServiceClient) GetCategoryById(ctx context.Context, in *CategoryRequestById, opts ...grpc.CallOption) (*CategoryResponseById, error) {
	out := new(CategoryResponseById)
...
type CategoryServiceServer interface {
	...
	GetCategoryById(context.Context, *CategoryRequestById) (*CategoryResponseById, error)
...
func (UnimplementedCategoryServiceServer) GetCategoryById(context.Context, *CategoryRequestById) (*CategoryResponseById, error) {
...
func _CategoryService_GetCategoryById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).GetCategoryById(ctx, req.(*CategoryRequestById))
	}
	return interceptor(ctx, in, info, handler)
}
