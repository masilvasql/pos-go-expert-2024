...
type CategoryRequestById struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CategoryRequestById) Reset() {
	*x = CategoryRequestById{}
	if protoimpl.UnsafeEnabled {
...
func (x *CategoryRequestById) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CategoryRequestById) ProtoMessage() {}

func (x *CategoryRequestById) ProtoReflect() protoreflect.Message {
	mi := &file_proto_course_category_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CategoryRequestById.ProtoReflect.Descriptor instead.
func (*CategoryRequestById) Descriptor() ([]byte, []int) {
	return file_proto_course_category_proto_rawDescGZIP(), []int{5}
}

func (x *CategoryRequestById) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *CategoryResponseById) Reset() {
	*x = CategoryResponseById{}
	if protoimpl.UnsafeEnabled {
...
func (x *CategoryResponseById) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CategoryResponseById) ProtoMessage() {}

func (x *CategoryResponseById) ProtoReflect() protoreflect.Message {
	mi := &file_proto_course_category_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CategoryResponseById.ProtoReflect.Descriptor instead.
func (*CategoryResponseById) Descriptor() ([]byte, []int) {
	return file_proto_course_category_proto_rawDescGZIP(), []int{6}
}

func (x *CategoryResponseById) GetCategory() *Category {
	if x != nil {
		return x.Category
	}
	return nil
...
var file_proto_course_category_proto_rawDesc = []byte{
	...
	0x65, 0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x22, 0x25, 0x0a, 0x13, 0x43, 0x61, 0x74, 0x65, 0x67,
	0x6f, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x42, 0x79, 0x49, 0x64, 0x12, 0x0e,
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x40,
	0x0a, 0x14, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x42, 0x79, 0x49, 0x64, 0x12, 0x28, 0x0a, 0x08, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f,
	...
	0x32, 0xea, 0x02, 0x0a, 0x0f, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x53, 0x65, 0x72,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x47, 0x0a, 0x14, 0x43, 0x72, 0x65,
	...
	0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x12, 0x2d, 0x0a, 0x0c, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x61,
	...
	0x69, 0x73, 0x74, 0x22, 0x00, 0x12, 0x46, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65,
	0x67, 0x6f, 0x72, 0x79, 0x42, 0x79, 0x49, 0x64, 0x12, 0x17, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x61,
	0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x42, 0x79, 0x49,
	0x64, 0x1a, 0x18, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x79, 0x49, 0x64, 0x22, 0x00, 0x42, 0x0d, 0x5a,
...
var file_proto_course_category_proto_goTypes = []interface{}{
	...
	(*CategoryRequestById)(nil),   // 5: pb.CategoryRequestById
	(*CategoryResponseById)(nil),  // 6: pb.CategoryResponseById
}
var file_proto_course_category_proto_depIdxs = []int32{
	...
	1, // 2: pb.CategoryResponseById.category:type_name -> pb.Category
	...
	0, // 6: pb.CategoryService.ListCategory:input_type -> pb.blank
	5, // 7: pb.CategoryService.GetCategoryById:input_type -> pb.CategoryRequestById
	...
	4, // 11: pb.CategoryService.ListCategory:output_type -> pb.CategoryList
	6, // 12: pb.CategoryService.GetCategoryById:output_type -> pb.CategoryResponseById
...
func file_proto_course_category_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_course_category_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CategoryRequestById); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_course_category_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CategoryResponseById); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
